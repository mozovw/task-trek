...
2007.06.30 12:08:55
[1183135260000,1776303275143]
[1183135260000,1776303275158]
[1183135260000,1776303275170]
[1183135260000,1776303275182]
...
| month-format | string | 'M' | 设置面板中月份的显示方式，详情见 format | 2.37.0 |
...
| quarter-format | string | 'Q'Q | 设置面板中季度的显示方式，详情见 format | 2.37.0 |
...
| time-picker-format | string | undefined | undefined | 日期面板内时间的显示方式，详情见 format | 2.38.2 |
...
| year-format | string | 'y' | 设置面板中年的显示方式，详情见 format | 2.37.0 |
...
| format | string | 'yyyy-MM-dd' | 时间格式化字符串，详情见 format | 2.28.3 |
...
| default-calendar-start-time | number | undefined | 面板日历默认开始的月份时间戳 | 2.38.1 |
| format | string | 中文为 'YYYY-w'，随语言变化 | 时间格式化字符串，详情见 format | 2.37.0 |
